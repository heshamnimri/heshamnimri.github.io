...
export const metadata: Metadata = {
  ...
  description:
    "Documenting democracy in the Bronx and Manhattan on election day — a photojournalism essay by Hesham Nimri covering the 2024 US elections in New York City.",
  alternates: {
    canonical: "https://hishamnimri.com/blog/elections-behind-the-lens",
  },
  openGraph: {
    title: "Behind the Lens: Covering the 2024 Elections",
    description:
...
const articleJsonLd = {
  ...
  "@type": "Article",
  headline: "Behind the Lens: Covering the 2024 Elections",
  ...
  image: "https://hishamnimri.com/photos/elections/1.jpg",
  description:
    "Documenting democracy in the Bronx and Manhattan on election day.",
};
